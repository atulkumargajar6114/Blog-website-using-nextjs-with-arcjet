  ...
  return(
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-gradient-to-br from-gray-100 to-gray-200">
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 lg:p-12">
        <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-lg shadow-lg">
          <div className="space-y-2 text-center">
            ...
            <Link className="font-semibold text-black hover:text-black ml-3" href={'/register'}>Register</Link>
            </p>
      ...
      <div className="hidden md:flex w-1/2 p-12 items-center justify-center relative">
          <div className="max-w-lg space-y-10 text-white z-10">
            <h2 className="text-4xl text-white font-medium">Join us to explore the best blog experience</h2>
            <p className="text-right text-lg text-black font-bold">-Atul</p>
          </div>
          <div className="absolute inset-0 bg-black opacity-50"></div>
          <img src="/images/auth.jpg" alt="workspace" className="absolute inset-0 object-cover w-full h-full" />
        </div>
    </div>
  )
}